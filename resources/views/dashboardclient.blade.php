                ...
                <nav class="navbar-mobile">
                    <div class="container-fluid">
                        <ul class="navbar-mobile__list list-unstyled">
                            <li class="has-sub">
                                <a class="js-arrow" href="dashboardclient">
                                    <i class="fas fa-tachometer-alt"></i>Historique de commande</a>

                            <li>
                                <a href="passconnexion">
                                    <i class="far fa-check-square"></i>mot de passe pour Connexion</a>
                            </li>
                    ...
                    <nav class="navbar-sidebar">
                        <ul class="list-unstyled navbar__list">
                            <li class="active has-sub">
                                <a class="js-arrow" href="dashboardclient">
                                    <i class="fas fa-tachometer-alt"></i>Historique des commandes</a>
                                                        ...
                                                        <div class="au-message__item-inner">
                                                            <div class="au-message__item-text">
                                                                <div class="avatar-wrap">
                                                                    <div class="avatar">
                                                                        <img src="{{('coolAdmin/images/icon/avatar-02.jpg')}}" alt="John Smith">
                                                                    </div>
                                                                </div>
                                                                <div class="text">
                                                        ...
                                                        <div class="au-message__item-inner">
                                                            <div class="au-message__item-text">
                                                                <div class="avatar-wrap online">
                                                                    <div class="avatar">
                                                                        <img src="{{('coolAdmin/images/icon/avatar-03.jpg')}}" alt="Nicholas Martinez">
                                                                    </div>
                                                                </div>
                                                                <div class="text">
                                                    ...
                                                    <div class="au-message__item">
                                                        <div class="au-message__item-inner">
                                                            <div class="au-message__item-text">
                                                                <div class="avatar-wrap online">
                                                                    <div class="avatar">
                                                                        <img src="{{('coolAdmin/images/icon/avatar-04.jpg')}}" alt="Michelle Sims">
                                                                    </div>
                                                                </div>
                                                                <div class="text">
                                                    ...
                                                    <div class="au-message__item">
                                                        <div class="au-message__item-inner">
                                                            <div class="au-message__item-text">
                                                                <div class="avatar-wrap">
                                                                    <div class="avatar">
                                                                        <img src="{{('coolAdmin/images/icon/avatar-05.jpg')}}" alt="Michelle Sims">
                                                                    </div>
                                                                </div>
                                                                <div class="text">
                                                                    <h5 class="name">Michelle Sims</h5>
